...
"));
    ...
    class BenchPlant "COST Benchmark WWTP Configuration"
      ...
      BSM1.divider2 divider
        annotation (Placement(transformation(extent={{20,-6},{40,14}})));
      WasteWater.BSM1.nitri_5      tank5(V=1333)
        annotation (Placement(transformation(extent={{-6,-6},{14,14}})));
      ...
      BSM1.mixer3 mixer
        annotation (Placement(transformation(extent={{-104,22},{-84,42}})));
      BSM1.WWSource WWSource
        annotation (Placement(transformation(extent={{-80,47},{-100,67}})));
    ...
    equation
      ...
      connect(mixer.Out, tank1.In) annotation (Line(points={{-84,31.6},{-80,
              31.6},{-80,32},{-76,32}}));
      connect(mixer.In1, WWSource.Out) annotation (Line(points={{-104,35.5},{-104,50},
              {-99.8,50}}));
      ...
      connect(WastePump.u, Constant2.y)
        annotation (Line(points={{60.1,-42.5},{46,-42.5},{46,-60},{41,-60}},
                                                                       color={0,0,
              255}));
      connect(sensor_NH1.In, Settler.Effluent) annotation (Line(points={{72,15},
              {72,10.7},{68.2,10.7}}));
      ...
      connect(Constant2.y, ReturnPump.u)
        annotation (Line(points={{41,-60},{46,-60},{46,-28.5},{34.9,-28.5}},
                                                                         color={0,
              0,255}));
...
air between blower and nitrification tank."));
    ...
    partial model ASM1base "Base class of WWTP modelling by ASM1"
      ...
      parameter Real b_h=0.3 "Heterotrophic decay rate at T=15 deg C [day^-1]";
      parameter Real mu_a=0.5
        "Maximum autotrophic growth rate at T=15 deg C[day^-1]";
      parameter Real b_a=0.05 "Autotrophic decay rate at T=15 deg C [day^-1]";
      parameter Real k_a=0.05
        "Ammonification rate at T=15 deg C [m3/(g COD day)]";
      parameter Real k_h=3
...
model nitri_5 "ASM1 nitrification tank"
  ...
  // aeration system dependent parameters
  parameter Real alpha=0.7 "Oxygen transfer factor";
  parameter Real Kla=84 "Oxygen transfer factor new";
  parameter Modelica.SIunits.Length de=4.5 "depth of aeration";
  parameter Real R_air=23.5 "specific oxygen feed factor [gO2/(m^3*m)]";
  WWU.MassConcentration So_sat "Dissolved oxygen saturation";
