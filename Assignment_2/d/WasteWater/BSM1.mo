...
"));
    ...
    equation
      ...
      connect(RecyclePump.Out, mixer.In3) annotation (Line(points={{-94,-15.8},
              {-110,-15.8},{-110,-16},{-118,-16},{-118,27},{-104,27},{-104,27.5}}));
      ...
      connect(tank3.Kla, sensor_AE.Kla3) annotation (Line(points={{-50,9},{-50,
              16},{-10,16},{-10,60},{17,60},{17,64}}, color={0,0,127}));
      connect(tank4.Kla, sensor_AE.Kla4) annotation (Line(points={{-22,9},{-22,
              12},{-2,12},{-2,55},{24,55},{24,64}}, color={0,0,127}));
      connect(tank5.Kla_out, sensor_AE.Kla5) annotation (Line(points={{4,9},{4,
              50},{31,50},{31,64}}, color={0,0,127}));
      annotation (
        Diagram(coordinateSystem(
            preserveAspectRatio=false,
