...
model SecClarModTakacs "Secondary Clarifier ASM1 Model based on Takacs"
  ...
  extends BSM1.SecClar.Takacs.Interfaces.ratios;
  package SCP = BSM1.SecClar.Takacs;
...
"));
  ...
  package Examples "Demonstration examples of the components of the ASM1 library"
    ...
    class SmallPlant "Small WWTP Configuration"
      ...
      BSM1.pump RecyclePump(Q_max=46115) annotation (Placement(transformation(
            origin={-84,-12},
            extent={{-10,-10},{10,10}},
            rotation=180)));
      BSM1.pump ReturnPump(Q_max=9223) annotation (Placement(transformation(
            origin={26,-26},
            extent={{-10,-10},{10,10}},
            rotation=180)));
      BSM1.pump WastePump(Q_max=193)
...
"));
    ...
    class BenchPlant "COST Benchmark WWTP Configuration"
      ...
      BSM1.SludgeSink WasteSludge
        annotation (Placement(transformation(extent={{133,-76},{153,-56}})));
      BSM1.EffluentSink Effluent
        annotation (Placement(transformation(extent={{87,-24},{107,-4}})));
      BSM1.SecClarModTakacs Settler
        annotation (Placement(transformation(extent={{48,-5},{68,15}})));
      BSM1.divider2 divider
        annotation (Placement(transformation(extent={{20,-6},{40,14}})));
      WasteWater.BSM1.nitri_5_konst tank5(
                                         V=1333)
        annotation (Placement(transformation(extent={{-6,-6},{14,14}})));
      BSM1.nitri tank4(V=1333)
      ...
      Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
        ...
        fileName=ModelicaServices.ExternalReferences.loadResource(
            "modelica://WasteWater/Resources/ASM1/Inf_dry.txt"))
                                             annotation (Placement(transformation(
              extent={{-110,80},{-130,100}})));
      BSM1.WWSource WWSource
        annotation (Placement(transformation(extent={{-134,49},{-114,69}})));
      BSM1.sensor_NO sensor_NO
      ...
      Modelica.Blocks.Sources.Constant Constant1(k=55338)
            ...
            transformation(extent={{-90,-60},{-70,-40}})));
      BSM1.pump RecyclePump(Q_max=55338) annotation (Placement(transformation(
            origin={-84,-13},
            extent={{-10,-10},{10,10}},
            rotation=180)));
      BSM1.pump ReturnPump(Q_max=18446) annotation (Placement(transformation(
            origin={-15,-42},
            extent={{-10,-10},{10,10}},
            rotation=180)));
      BSM1.pump WastePump(Q_max=385)
      ...
      WasteWater.ASM1.sensor_TSS sensor_TSS1 annotation (Placement(transformation(
              extent={{32,15},{48,30}})));
      WasteWater.BSM1.sensor_AE sensor_AE
        annotation (Placement(transformation(extent={{14,63},{34,83}})));
      WasteWater.BSM1.sensor_ME sensor_ME
        annotation (Placement(transformation(extent={{-29,81},{-9,101}})));
      WasteWater.BSM1.sensor_IQ sensor_IQ
        annotation (Placement(transformation(extent={{-113,42},{-93,62}})));
      WasteWater.BSM1.sensor_EQ sensor_EQ
        annotation (Placement(transformation(extent={{69,-13},{89,7}})));
      WasteWater.BSM1.sensor_PE sensor_PE
        annotation (Placement(transformation(extent={{45,-36},{65,-15}})));
      WasteWater.BSM1.sensor_SP sensor_SP
        annotation (Placement(transformation(extent={{100,-67},{120,-47}})));
      WasteWater.BSM1.OCI oCI
        annotation (Placement(transformation(extent={{137,-9},{157,11}})));
    equation
      ...
      connect(tank3.In, tank2.Out) annotation (Line(points={{-60,4},{-70,4},{
              -70,20},{-20,20},{-20,32},{-28,32}}));
      ...
      connect(mixer.Out, tank1.In) annotation (Line(points={{-84,31.6},{-80,
              31.6},{-80,32},{-76,32}}));
      connect(CombiTableTime.y, WWSource.data)
        annotation (Line(points={{-131,90},{-136,90},{-136,59},{-133,59}}));
      connect(sensor_NO.In, tank2.MeasurePort) annotation (Line(points={{-32,48},
              {-32,36.5},{-32.5,36.5}}));
      connect(RecyclePump.Out, mixer.In3) annotation (Line(points={{-94,-15.8},
              {-104,-15.8},{-104,27.5}}));
      connect(ReturnPump.Out, mixer.In2) annotation (Line(points={{-25,-44.8},{
              -35.5,-44.8},{-35.5,-27},{-127,-27},{-127,31.5},{-104,31.5}}));
      connect(WastePump.u, Constant2.y)
        annotation (Line(points={{71.1,-53.5},{46,-53.5},{46,-80},{21,-80}},
                                                                       color={0,0,
              255}));
      connect(sensor_NH1.In, Settler.Effluent) annotation (Line(points={{72,15},
              {72,10.7},{68.2,10.7}}));
      ...
      connect(Constant2.y, ReturnPump.u)
        annotation (Line(points={{21,-80},{46,-80},{46,-44.5},{-6.1,-44.5}},
                                                                         color={0,
              0,255}));
      connect(tank5.MeasurePort, sensor_O2.In) annotation (Line(points={{9.5,8.5},
              {9.5,25},{9.5,25}}));
      connect(sensor_TSS1.In, divider.Out1) annotation (Line(points={{40,15},{
              40,6.6}}));

      connect(Constant1.y, RecyclePump.u) annotation (Line(points={{-69,-50},{
              -66,-50},{-66,-15.5},{-75.1,-15.5}}, color={0,0,127}));
      connect(tank1.Kla, sensor_ME.Kla1) annotation (Line(points={{-66,37.4},{
              -66,76},{-27,76},{-27,81}}, color={0,0,127}));
      connect(tank2.Kla, sensor_ME.Kla2) annotation (Line(points={{-38,37.4},{
              -38,71},{-23,71},{-23,81}}, color={0,0,127}));
      connect(tank3.Kla, sensor_ME.Kla3) annotation (Line(points={{-50,9},{-50,
              17},{-19,17},{-19,81}}, color={0,0,127}));
      connect(tank4.Kla, sensor_ME.Kla4)
        annotation (Line(points={{-22,9},{-15,9},{-15,81}}, color={0,0,127}));
      connect(tank5.Kla_out, sensor_ME.Kla5)
        annotation (Line(points={{4,9},{-11,9},{-11,81}}, color={0,0,127}));
      connect(sensor_AE.Kla3, sensor_ME.Kla3) annotation (Line(points={{17,64},
              {17,55},{-19,55},{-19,81}}, color={0,0,127}));
      connect(sensor_AE.Kla4, sensor_ME.Kla4) annotation (Line(points={{24,64},
              {24,50},{-15,50},{-15,81}}, color={0,0,127}));
      connect(sensor_AE.Kla5, sensor_ME.Kla5) annotation (Line(points={{31,64},
              {31,45},{-11,45},{-11,81}}, color={0,0,127}));
      connect(WWSource.Out, sensor_IQ.In)
        annotation (Line(points={{-114.2,52},{-110,52}}));
      connect(mixer.In1, sensor_IQ.Out) annotation (Line(points={{-104,35.5},{
              -103,35.5},{-103,43}}, color={0,0,255}));
      connect(Effluent.In, sensor_EQ.Out)
        annotation (Line(points={{87,-12},{79,-12}}, color={0,0,255}));
      connect(sensor_EQ.In, Settler.Effluent) annotation (Line(points={{72,-3},
              {68,-3},{68,10.7},{68.2,10.7}}, color={0,0,255}));
      connect(WastePump.Out, sensor_SP.In)
        annotation (Line(points={{90,-53.2},{90,-57},{103,-57}}));
      connect(sensor_SP.Out, WasteSludge.In) annotation (Line(points={{110,-67},
              {120,-67},{120,-67.2},{133,-67.2}}, color={0,0,0}));
      connect(sensor_PE.Out_w, WastePump.In) annotation (Line(points={{61,-31.8},
              {61,-59.3},{70,-59.3}}, color={0,0,0}));
      connect(Settler.Waste, sensor_PE.In_w)
        annotation (Line(points={{61,-4.6},{61,-19.2}}, color={0,0,0}));
      connect(Settler.Return, sensor_PE.In_r)
        annotation (Line(points={{55,-4.6},{55,-19.2}}, color={0,0,0}));
      connect(sensor_PE.Out_r, ReturnPump.In) annotation (Line(points={{55,
              -31.8},{55,-38.7},{-5,-38.7}}, color={0,0,0}));
      connect(sensor_PE.In_a, divider.Out2) annotation (Line(points={{49,-19.2},
              {49,-8.6},{40,-8.6},{40,2.5}}, color={0,0,255}));
      connect(sensor_PE.Out_a, RecyclePump.In) annotation (Line(points={{49,
              -31.8},{-13,-31.8},{-13,-9.7},{-74,-9.7}}, color={0,0,0}));
      connect(sensor_AE.AE, oCI.AE) annotation (Line(points={{33,73},{125,73},{
              125,3.6},{139,3.6}}, color={0,0,127}));
      connect(sensor_ME.ME, oCI.ME) annotation (Line(points={{-9.2,91},{130,91},
              {130,8.8},{139,8.8}}, color={0,0,127}));
      connect(sensor_PE.PE, oCI.PE) annotation (Line(points={{64.8,-25.5},{
              121.9,-25.5},{121.9,-1.6},{139,-1.6}}, color={0,0,127}));
      connect(oCI.SP, sensor_SP.SP) annotation (Line(points={{139,-6.8},{130,
              -6.8},{130,-57},{119.8,-57}}, color={0,0,127}));
      annotation (
        Diagram(coordinateSystem(
            preserveAspectRatio=false,
            extent={{-140,-100},{180,120}},
            grid={1,1})),
...
"),     experiment(
        ...
        Icon(coordinateSystem(extent={{-140,-100},{180,120}})));
    end BenchPlant;
...
"));
      ...
      model SecClarModHaertel "ASM1 Secondary Settling Tank Model based on Haertel"
        ...
        extends WasteWater.Icons.SecClar;
        extends BSM1.SecClar.Haertel.Interfaces.ratios;
        package SCP = BSM1.SecClar.Haertel;
        import SI = Modelica.SIunits;
        package WI = BSM1.Interfaces;
        package WWU = WasteWater.WasteWaterUnits;
        parameter SI.Length hsc=4.0 "height of secondary clarifier";
...
"));
      ...
      model SecClarModOtter "Secondary Clarifier Model based on Otterpohl (ASM1)"
        ...
        extends WasteWater.Icons.SecClar;
        extends BSM1.SecClar.Otterpohl.Interfaces.ratios;
        package SCP = BSM1.SecClar.Otterpohl;
        import SI = Modelica.SIunits;
        package WI = BSM1.Interfaces;
        package WWU = WasteWater.WasteWaterUnits;
        parameter SI.Length hsc=4.0 "height of secondary clarifier";
...
model nitri_5 "ASM1 nitrification tank"
  ...
  Interfaces.AirFlow AirIn annotation (Placement(transformation(extent={{-5,
            -103},{5,-93}})));
  Modelica.Blocks.Interfaces.RealOutput Kla_out annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={0,50})));
...
model sensor_AE
  ...
  Modelica.Blocks.Interfaces.RealInput Kla5 annotation (Placement(
        transformation(extent={{-20,-20},{20,20}},
          rotation=90,
          origin={80,-100}),                          iconTransformation(extent={{-10,-10},
              {10,10}},
          rotation=90,
          origin={70,-90})));
  Modelica.Blocks.Interfaces.RealInput Kla4 annotation (Placement(
        transformation(extent={{-20,-20},{20,20}},
          rotation=90,
          origin={0,-100}),                           iconTransformation(extent={{-10,-10},
              {10,10}},
          rotation=90,
          origin={0,-90})));
  Modelica.Blocks.Interfaces.RealInput Kla3 annotation (Placement(
        transformation(extent={{-20,-20},{20,20}},
          rotation=90,
          origin={-70,-100}),                         iconTransformation(extent={{-10,-10},
              {10,10}},
          rotation=90,
          origin={-70,-90})));
...
model sensor_ME "Influent quality index"
...
equation
  ...
  ME_tank_1 = if Kla1 < 20 then 0.005*1000 else 0;
  ME_tank_2 = if Kla2 < 20 then 0.005*1000 else 0;
  ME_tank_3 = if Kla3 < 20 then 0.005*1333 else 0;
  ME_tank_4 = if Kla4 < 20 then 0.005*1333 else 0;
  ME_tank_5 = if Kla5 < 20 then 0.005*1333 else 0;

  der(T) = 1.0;
  der(ME*T) = 24*(ME_tank_1 + ME_tank_2 + ME_tank_3 + ME_tank_4 + ME_tank_5);
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
            {100,100}}), graphics), Diagram(coordinateSystem(
          preserveAspectRatio=false, extent={{-100,-100},{100,100}})));
end sensor_ME;

model sensor_IQ "Influent quality index"
...
equation
  ...
  S_NKj0 = In.Snh + In.Snd + In.Xnd + i_xb * (In.Xbh) + i_xp * (In.Xp + In.Xi);
  SS_0 = 0.75 * (In.Xs + In.Xi + In.Xbh + In.Xba + In.Xp);
  BOD_50 = 0.65 * (In.Ss + In.Xs + (1-f_p) * (In.Xbh + In.Xba));
  COD_0 = In.Ss + In.Si + In.Xs + In.Xi + In.Xbh + In.Xba + In.Xp;
  der(T) = 1.0;
...
model sensor_EQ "Influent quality index"
...
model sensor_PE "Total pump energy"
...
equation
  ...
  der(T) = 1.0;
  der(SP*T) = (1/1000)*0.75*(In.Xs + In.Xi + In.Xbh + In.Xba + In.Xp)*In.Q;
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
            {100,100}}), graphics), Diagram(coordinateSystem(
          preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics));
end sensor_SP;
...
model OCI "Sludge production"
  ...
  Modelica.Blocks.Interfaces.RealInput PE annotation (Placement(
        transformation(extent={{-90,-36},{-70,-16}})));
  Modelica.Blocks.Interfaces.RealInput AE annotation (Placement(
        transformation(extent={{-90,16},{-70,36}})));
...
model nitri_5_konst "ASM1 nitrification tank"
  // nitrification (aerated) tank, based on the ASM1 model
